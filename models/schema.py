...
class DBBookMetaData(Base):
    ...
    id:Mapped[int] = mapped_column(Column(Integer,primary_key=True,nullable=False, autoincrement=True))
    gb_id:Mapped[int] = mapped_column(Column(Integer,nullable=False))
    title:Mapped[str] = mapped_column(Column(String,nullable=False))
    authors:Mapped[str] = mapped_column(Column(String, nullable=False)        )
    lang:Mapped[str] = mapped_column(Column(String, nullable=False))
