    ...
    async def answer_with_context(
        ...
        *,
        ...
        if len(relev_chunk_hits) == 0 and len(chunk_hits) > 0:
            ...
            llm_answer = resp.output_parsed     # type:ignore
    ...
    async def answer_with_context(
        ...
        *,
        ...
        if chunk_hits:
            ...
            citations.append(
                ChunkCitation(
                    book_name=top.book_name if top.book_name else "Mock dummy book_name",
                    chunk_content=top.content or "",
                    chunk_nr=top.chunk_id if top.chunk_id else -1,
                )
            )
